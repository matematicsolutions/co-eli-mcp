...
Pulls a tiny static ``co-runtime.json.gz`` from this repo's GitHub Release on
first tool call so a dead endpoint can be repointed (edit runtime/co-runtime.json
...
Opt-out: set ``CO_ELI_RUNTIME_URL=""`` to disable the fetch.
"""
...
MANIFEST_URL = os.environ.get(
    "CO_ELI_RUNTIME_URL",
    "https://github.com/matematicsolutions/co-eli-mcp/releases/latest/download/co-runtime.json.gz",
)
_CACHE_NAME = "co-runtime.json"
_TIMEOUT = 15
_USER_AGENT = "co-eli-mcp-runtime (+https://github.com/matematicsolutions/co-eli-mcp)"
